...
UInt ParameterViewSyn::setup()
{
	...
	m_pCfgLines[uiParLnCount++] = new ConfigLineStr("VideoName", &m_cVideoName, "dog038.yuv");
	m_pCfgLines[uiParLnCount++] = new ConfigLineStr("OutputBackgroundImageName", &m_cOutputBackgroundImageName, "dog_virtual039.yuv");
